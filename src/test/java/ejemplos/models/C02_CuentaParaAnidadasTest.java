 ...
 * 
 * NOTA: MUY MUY IMPORTANTE tuve problemas para ejecutarlo aquí, los @Nested NO funcionaban
 * el problema es que en el pom en plugin no estaba la última version de maven-surefire-plugin
 * ya con última version ya funciona.
 */
...
public class C02_CuentaParaAnidadasTest
{
    ...
    void testAntesDeCada()
    {
        ...
        this.cuenta= new C02_CuentaParaAnidadas("Andres", new BigDecimal("1000.12345"));  //se instancia un objeto de la clas a probar
    }
    ...
    class SimplesTest
    {
        ...
        {
            cuenta = new C02_CuentaParaAnidadas("Jhon Doe", new BigDecimal("8900.997")); //valor real
            C02_CuentaParaAnidadas cuenta2 = new C02_CuentaParaAnidadas("Jhon Doe", new BigDecimal("8900.997")); //valor esperado
        ...
        {
            C02_CuentaParaAnidadas cuenta1 = new C02_CuentaParaAnidadas("Jhon Doe", new BigDecimal("2500"));
            C02_CuentaParaAnidadas cuenta2 = new C02_CuentaParaAnidadas("Andres", new BigDecimal("1500.8989"));

            C02_BancoParaAnidadas banco = new C02_BancoParaAnidadas();
...
/************************  TEST ASSUMPTION (SUPOSICIONES)*************************************/
    ...
    class AssumptionTest
    {
        ...
        {
            cuenta.setBanco(new C02_BancoParaAnidadas());
