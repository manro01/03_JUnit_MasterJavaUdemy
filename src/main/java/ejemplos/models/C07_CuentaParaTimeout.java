...
public class C07_CuentaParaTimeout
{
    private String persona;
    private BigDecimal saldo;
    
    private C07_BancoParaTimeout banco;
    ...
    public C07_CuentaParaTimeout(String persona, BigDecimal saldo)
    {
        this.saldo = saldo;
    ...
    public C07_BancoParaTimeout getBanco()
    {
        return banco;
    }

    public void setBanco(C07_BancoParaTimeout banco)
    {
        this.banco = banco;
    }
    ...
    public boolean equals(Object obj)
    {
        ...
        final C07_CuentaParaTimeout other = (C07_CuentaParaTimeout) obj; //crea un objeto nuevo con lo mandado por parámetro
