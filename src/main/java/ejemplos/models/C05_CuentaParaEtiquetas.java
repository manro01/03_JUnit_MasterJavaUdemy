 ...
 * Es lo mismo que estaba en C04_CuentaParaEtiquetas
 */
...
public class C05_CuentaParaEtiquetas
{
    private String persona;
    private BigDecimal saldo;
    
    private C05_BancoParaEtiquetas banco;
    ...
    public C05_CuentaParaEtiquetas(String persona, BigDecimal saldo)
    {
        this.saldo = saldo;
    ...
    public C05_BancoParaEtiquetas getBanco()
    {
        return banco;
    }

    public void setBanco(C05_BancoParaEtiquetas banco)
    {
        this.banco = banco;
    }
    ...
    public boolean equals(Object obj)
    {
        ...
        final C05_CuentaParaEtiquetas other = (C05_CuentaParaEtiquetas) obj; //crea un objeto nuevo con lo mandado por parámetro
